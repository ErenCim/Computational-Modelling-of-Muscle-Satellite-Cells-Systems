...
df = pd.read_csv("gd_sweep_runs/sweep_results.csv")
...
# Full PCA (all components so scree makes sense)
...
plt.ylabel("% Variance Explained (In Log Space)")
...
loadings.to_csv("gd_sweep_runs/pca_loadings.csv", index=True)
...
out_path = "gd_sweep_runs/pca_parameter_summary.csv"
